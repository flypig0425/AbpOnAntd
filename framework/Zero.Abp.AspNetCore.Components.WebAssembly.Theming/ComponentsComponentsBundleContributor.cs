...
namespace Zero.Abp.AspNetCore.Components.WebAssembly.Theming
{
    public class ComponentsComponentsBundleContributor : IBundleContributor
    {
        ...
        public void AddStyles(BundleContext context)
        {
            ...
            {
                Source = "_content/Zero.Abp.AspNetCore.Components.WebAssembly.Theming/libs/bootstrap/css/bootstrap.min.css"
            });
            context.BundleDefinitions.Insert(1, new BundleDefinition
            {
                Source = "_content/Zero.Abp.AspNetCore.Components.WebAssembly.Theming/libs/fontawesome/css/all.css"
            });
            
            context.Add("_content/Zero.Abp.AspNetCore.Components.WebAssembly.Theming/libs/flag-icon/css/flag-icon.css");

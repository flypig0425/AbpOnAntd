...
namespace Zero.Abp.AntdesignUI.Components
{
    public partial class UiNotificationAlert : ComponentBase, IDisposable
    {
        ...
        [Inject] protected AntdesignUiNotificationService UiNotificationService { get; set; }
        ...
        protected virtual async void OnNotificationReceived(object sender, UiNotificationEventArgs e)
        {
            ...
            await Notification.SetParametersAsync(Message, Title, GetSnackbarColor( e.NotificationType ), (options) =>
            {
